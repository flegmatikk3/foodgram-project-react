    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=150, unique=True, validators=[users.validators.UsernameValidator(regex='^[\\w.@+-]+$'), django.core.validators.RegexValidator(message='Username cannot be "me".', regex='^(?!me$)')], verbose_name='username')),
